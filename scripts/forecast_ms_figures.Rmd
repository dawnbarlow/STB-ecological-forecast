...
gridSTB.df <- read.csv("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/gridSTB.pointlocations.df.csv")
...
bathy_STB.df$Depth <- (bathy_STB.df$NIWA_depth_rast_.5x.5)* -1
...
StudyArea.map1 <- ggplot() +
  ...
  ylab("Latitude") + xlab("Longitude") + labs(fill="Depth (m)") +
  theme(legend.justification=c(1,0), legend.position=c(.98,.25))
...
ggsave(StudyArea.map2, filename="C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/forecast models manuscript/plots/StudyAreaMap_rev.png", device = "png", height=140, width=180, units="mm")
...
predvalues.background.list <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/predvalues.background.list.rds")
predvalues.sightings.list <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/predvalues.sightings.list.rds")
...
perf.at.thresh.df <- read.csv("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/WhaleModel.Performance.at.thresh.df.csv")
...
perf.at.thresh.plot <- ggplot(data = perf.at.thresh.df, aes(x=thresholds)) +
  ...
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  xlab("Threshold") + ylab("Proportion") + theme_classic() #+
  #theme(legend.position=c(.9, .56))

perf.at.thresh.plot

ggsave(perf.at.thresh.plot, file="C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/forecast models manuscript/plots/WhaleModel.perf.at.thresh_v2.png",
         width = 180, height=80, units = "mm")
...
```{r}
# PA data data (all sightings and background points)
PA_AllSightings.df <- read.csv("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/SightingsBackgroundPoints.RSdata.forecast_Jan2021.csv")
PA_AllSightings.df$X <- NULL
...
ggsave(sightingsmap, file="C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/forecast models manuscript/plots/sightingsmap.png",
         width = 180, height = 115, units = "mm")
...
```{r}
# Read in models 
SSTwest_BRT <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/SSTwest_BRT.rds")
SSTcentral_BRT <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/SSTcentral_BRT.rds")
SSTeast_BRT <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/SSTeast_BRT.rds")

logNPPwest_BRT <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/logNPPwest_BRT.rds")
logNPPcentral_BRT <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/logNPPcentral_BRT.rds")
logNPPeast_BRT <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/logNPPeast_BRT.rds")
...
SSTwest_BRT.int <- gbm.interactions(SSTwest_BRT)
SSTwest_BRT.int$interactions
SSTwest_BRT.int$rank.list

SSTcentral_BRT.int <- gbm.interactions(SSTcentral_BRT)
#SSTcentral_BRT.int$interactions
SSTcentral_BRT.int$rank.list

SSTeast_BRT.int <- gbm.interactions(SSTeast_BRT)
#SSTeast_BRT.int$interactions
SSTeast_BRT.int$rank.list

logNPPwest_BRT.int <- gbm.interactions(logNPPwest_BRT)
#logNPPwest_BRT.int$interactions
logNPPwest_BRT.int$rank.list

logNPPcentral_BRT.int <- gbm.interactions(logNPPcentral_BRT)
#logNPPcentral_BRT.int$interactions
logNPPcentral_BRT.int$rank.list

logNPPeast_BRT.int <- gbm.interactions(logNPPeast_BRT)
#logNPPeast_BRT.int$interactions
logNPPeast_BRT.int$rank.list


##########################################################################################################################################
whales.allsightings_BRT <- readRDS("C:/Users/barlowd/Desktop/Box Sync/Documents - BoxSync to desktop/OSU/Blue Whales/Habitat/Forecast models/whales.allsightings_BRT2.rds")

whales.allsightings_BRT.int <- gbm.interactions(whales.allsightings_BRT)
int <- whales.allsightings_BRT.int$interactions
int
whales.allsightings_BRT.int$rank.list

###
gbm.perspec(whales.allsightings_BRT, 2,4,
            x.label = "\nDepth",
            y.label = "\nLog(NPP)",
            z.label = "\nProbability of Presence",
            col="blue")
gbm.perspec(whales.allsightings_BRT, 2,5,
            x.label = "\nDepth",
            y.label = "\nRelative SST",
            z.label = "\nProbability of Presence",
            col="blue")
gbm.perspec(whales.allsightings_BRT, 4,6,
            x.label = "\nLog(NPP)",
            y.label = "\nRelative log(NPP)",
            z.label = "\nProbability of Presence",
            col="blue")
gbm.perspec(whales.allsightings_BRT, 2,3,
            x.label = "\nDepth",
            y.label = "\nSST",
            z.label = "\nProbability of Presence",
            col="blue")
